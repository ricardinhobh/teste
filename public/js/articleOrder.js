...
$(document).on('click', '#addArticle', function (e) {
  ...
  var id = $(this).val();
  var articles = document.getElementById("articlesOrder");
  ...
  if (!isEmptyObject(document.getElementById('row' + id))) {
    ...
    var inputNumberArticle = document.createElement('input');
    ...
    var inputArticleName = document.createElement('input');
    ...
    var inputArticleAmount = document.createElement('input');
    ...
    var inputArticleTotal = document.createElement('input');
    ...
    var inputArticleTotalWithDiscount = document.createElement('input');
...
$(document).on('click', '#removeArticle', function (e) {
  ...
  if (!isEmptyObject(document.getElementById('row' + id))) {
    ...
    if (parseInt(document.getElementById('inputArticleAmount' + id).value) == 0) document.getElementById('row' + id).remove();
...
/***/ 1:
/*!********************************************!*\
  !*** multi ./resources/js/articleOrder.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\teste\resources\js\articleOrder.js */"./resources/js/articleOrder.js");
